...
Page({
  ...
  onLoad(options) {
    ...
    // 原生小程序中路由传参，对参数的长度有限制，长度过长会被自动截取掉
    // 通过路由跳转传参携带musicId给到详情页
  ...
  async getMusicInfo(musicId) {
    ...
    // 传入的参数songData.songs[0].dt的单位必须是毫秒
